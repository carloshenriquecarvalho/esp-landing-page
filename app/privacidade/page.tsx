      ...
      <main className="py-20 px-6">
        <article className="max-w-3xl mx-auto">
          ...
          <div className="prose prose-slate max-w-none text-gray-700 space-y-8">
            ...
            <section className="bg-slate-50 p-6 rounded-2xl border-l-4 border-esp-darkblue">
              <p className="text-sm italic">Ao solicitar sua análise, você autoriza o contato de um de nossos consultores via WhatsApp ou Telefone.</p>
            </section>
          </div>
        </article>
      </main>
